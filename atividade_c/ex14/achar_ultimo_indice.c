...
int main() {
    ...
    for (int i = 0; i < 10; i++) {
        ...
        printf("\nCaractere para achar o ultimo índice: %c", caracteres_para_serem_buscados[i][0]);
        indice = ultimo_indice(strings_para_testes[i], caracteres_para_serem_buscados[i][0]);
